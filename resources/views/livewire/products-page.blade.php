                ...
                <div class="flex flex-wrap mb-24 -mx-3">
                    ...
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                            <div>
                                <div>{{ Number::currency($price_range, 'USD')}}</div>
                                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="5000" value="0" step="0">
                                <div class="flex justify-between ">
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(0, 'USD')}}</span>
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(5000, 'USD')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                        <div class="border border-gray-300 dark:border-gray-700">
                            <div class="relative bg-gray-200 aspect-w-16 aspect-h-9">
                            ...
                            <div class="p-3 ">
                                <div class="flex items-center justify-between gap-2 mb-2">
                                    <h3 class="text-xl font-medium dark:text-gray-400 line-clamp-1">
                                        {{$product->name}}
                                    </h3>
                                </div>
                                <p class="text-lg">
